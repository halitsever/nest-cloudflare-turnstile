...
export class TurnstileService {
    private BASE_URL = 'https://challenges.cloudflare.com';

    constructor(private readonly httpService: HttpService, @Inject('TurnstileServiceOptions') private readonly options: ITurnstileOptions
    ) { }
